...
export default function ReactHookForm() {
  return (
    <Icon
      className="bg-[#ec5990] border-4 border-[#ffffff] rounded-xl p-2"
      title="React Hook Form logo"
      description="A white clipboard inside a bright pink rounded square"
      svgProps={{ viewBox: "0 0 100 100", fill: "#fff" }}
    >
